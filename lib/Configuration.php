...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.64.1/PHP';
    ...
    {
        $report  = 'PHP SDK (Dangl\AVACloud) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.64.1' . PHP_EOL;
        $report .= '    SDK Package Version: 1.64.1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://avacloud-api.dangl-it.com",
