...
class QuantityAssignmentDto implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Dangl/AVACloud\Dangl\AVACloud\CatalogueDto[] $project_catalogues These are Catalogue that are used within this ServiceSpecification. Catalogue references are used to describe catalogues, or collections, that can be used to describe elements with commonly known properties. For example, QuantityAssignments use these to categorize themselves.
     *
     * @return $this
     */
     ...
     *
     * @param \Dangl/AVACloud\Dangl\AVACloud\CatalogueReferenceDto[] $catalogue_references Referenced catalogues for this QuantityAssignment.
     *
     * @return $this
     */
