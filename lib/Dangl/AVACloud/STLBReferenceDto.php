...
class STLBReferenceDto implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cost_group' => 'string',
        'service_area' => 'string',
        'keys' => '\Dangl/AVACloud\Dangl\AVACloud\STLBKeyDto[]'
    ];
     ...
     * Gets keys
     *
     * @return \Dangl/AVACloud\Dangl\AVACloud\STLBKeyDto[]
     */
     ...
     * Sets keys
     *
     * @param \Dangl/AVACloud\Dangl\AVACloud\STLBKeyDto[] $keys These keys may optionally be used to further reference multiple, specific items within the STLB
     *
     * @return $this
     */
