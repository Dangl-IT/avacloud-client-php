...
class CatalogueReferenceDto implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'catalogue' => '\Dangl/AVACloud\Dangl\AVACloud\CatalogueDto'
    ];
     ...
     *
     * @param \Dangl/AVACloud\Dangl\AVACloud\CatalogueDto[] $project_catalogues These are CatalogueReference that are used within this ServiceSpecification. Catalogue references are used to describe catalogues, or collections, that can be used to describe elements with commonly known properties. For example, QuantityAssignments use these to categorize themselves.
     *
     * @return $this
     */
     ...
     * Sets catalogue
     *
     * @param \Dangl/AVACloud\Dangl\AVACloud\CatalogueDto $catalogue This returns the referenced catalogue. Will return null if there is no reference or the catalogue is not present in the ProjectCatalogues.
     *
     * @return $this
     */
