...
class Organization implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['identifier_scheme'] = isset($data['identifier_scheme']) ? $data['identifier_scheme'] : null;
     ...
     *
     * @param string $identifier_scheme BT-46 (BT-29 for the Seller) If a Identifier is used, this indicates the scheme used for the identifier. This works in conjunction with the Identifier property.
     *
     * @return $this
     */
