...
/**
 * PostAvaProjectMerge Class Doc Comment
 *
 * @category Class
 * @description This model represents the configuration needed to merge two AVA projects.
 * @package  Dangl\AVACloud
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostAvaProjectMerge implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostAvaProjectMerge';
     ...
     * Sets source_project
     *
     * @param \Dangl\AVACloud\Model\ProjectDto $source_project The source project from which to take prices and text additions.
     *
     * @return $this
     */
     ...
     * Sets target_project
     *
     * @param \Dangl\AVACloud\Model\ProjectDto $target_project The target project which will keep its structure and receive prices and text additions from the source project.
     *
     * @return $this
     */
