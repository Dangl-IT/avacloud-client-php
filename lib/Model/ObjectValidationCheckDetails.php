 ...
 */
class ObjectValidationCheckDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectValidationCheckDetails';
