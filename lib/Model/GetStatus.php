 ...
 */
class GetStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetStatus';
    ...
    */
     ...
     * Sets version
     *
     * @param string|null $version The current version of the AVACloud service
     *
     * @return self
     */
     ...
     * Sets environment
     *
     * @param string|null $environment The environment of the current instance
     *
     * @return self
     */
