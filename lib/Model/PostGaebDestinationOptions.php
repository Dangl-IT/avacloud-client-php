...
class PostGaebDestinationOptions implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Dangl\AVACloud\Model\DestinationGaebExchangePhase $target_exchange_phase_transform Defaults to none, meaning no transformation will be done. The phases are: Base = 81 CostEstimate = 82 OfferRequest = 83 Offer = 84 SideOffer = 85 Grant = 86
     *
     * @return $this
     */
