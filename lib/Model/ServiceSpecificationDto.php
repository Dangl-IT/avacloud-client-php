...
class ServiceSpecificationDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets origin
     *
     * @param \Dangl\AVACloud\Model\OriginDto $origin This indicates where the service specification originates, i.e. from an exchange file format or self created.
     *
     * @return $this
     */
     ...
     *
     * @param \Dangl\AVACloud\Model\CatalogueDto[] $project_catalogues These are Catalogues that are used within this ServiceSpecification. Catalogues are used to describe catalogues, or collections, that can be used to describe elements with commonly known properties. For example, QuantityAssignments use these to categorize themselves. They are propagate to all child elements, e.g. other containers and QuantityAssignments.
     *
     * @return $this
     */
