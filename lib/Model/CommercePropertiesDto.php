...
class CommercePropertiesDto implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['price_basis'] = isset($data['price_basis']) ? $data['price_basis'] : null;
        $this->container['sub_position_identifier'] = isset($data['sub_position_identifier']) ? $data['sub_position_identifier'] : null;
        $this->container['customer_base_item_number'] = isset($data['customer_base_item_number']) ? $data['customer_base_item_number'] : null;
    }
     ...
     * Sets price_basis
     *
     * @param float $price_basis This optional property can be used to indicate the basis for prices for a single position. Price basis means that the price is given per unit of the basis, e.g. per a pack of five when this property is set to '5'.
     *
     * @return $this
     */
     ...
     *
     * @param string $sub_position_identifier This optional property can be used to indicate a sub position identifier specific for the commerce exchange
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_base_item_number In a commerce exchange, this property is usually used to reference the base item number of an underlying phase 83 exchange file
     *
     * @return $this
     */
