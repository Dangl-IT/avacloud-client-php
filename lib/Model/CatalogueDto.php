...
class CatalogueDto implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['catalogue_type_detail'] = isset($data['catalogue_type_detail']) ? $data['catalogue_type_detail'] : null;
    }
     ...
     * Sets catalogue_type
     *
     * @param \Dangl\AVACloud\Model\CatalogueTypeDto $catalogue_type If given, this gives a classification for the contents of the catalogue
     *
     * @return $this
     */
     ...
     *
     * @param string $catalogue_type_detail This property may hold additional information about the catalogue type. It is currently only used in GAEB XML exchange to carry detailed information about a catalogue type, but it's otherwise just a free text field.
     *
     * @return $this
     */
