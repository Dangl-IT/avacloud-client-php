 ...
 */
class PositionHoldOutPropertiesDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PositionHoldOutPropertiesDto';
