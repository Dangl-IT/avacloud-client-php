...
class RebConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function rebConversionConvertToGaeb($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        list($response) = $this->rebConversionConvertToGaebWithHttpInfo($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function rebConversionConvertToGaebWithHttpInfo($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToGaebRequest($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToGaebAsync($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        return $this->rebConversionConvertToGaebAsyncWithHttpInfo($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToGaebAsyncWithHttpInfo($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToGaebRequest($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rebConversionConvertToGaebRequest($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
     ...
     * @return \SplFileObject
     */
    public function rebConversionConvertToOenorm($reb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        list($response) = $this->rebConversionConvertToOenormWithHttpInfo($reb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function rebConversionConvertToOenormWithHttpInfo($reb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToOenormRequest($reb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToOenormAsync($reb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        return $this->rebConversionConvertToOenormAsyncWithHttpInfo($reb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToOenormAsyncWithHttpInfo($reb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToOenormRequest($reb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rebConversionConvertToOenormRequest($reb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
