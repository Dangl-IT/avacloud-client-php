...
class RebConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function rebConversionConvertToGaeb($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null, $force_include_descriptions = null)
    {
        list($response) = $this->rebConversionConvertToGaebWithHttpInfo($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts, $force_include_descriptions);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function rebConversionConvertToGaebWithHttpInfo($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null, $force_include_descriptions = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToGaebRequest($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts, $force_include_descriptions);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToGaebAsync($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null, $force_include_descriptions = null)
    {
        return $this->rebConversionConvertToGaebAsyncWithHttpInfo($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts, $force_include_descriptions)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToGaebAsyncWithHttpInfo($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null, $force_include_descriptions = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToGaebRequest($reb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts, $force_include_descriptions);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rebConversionConvertToGaebRequest($reb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null, $force_include_descriptions = null)
    {
