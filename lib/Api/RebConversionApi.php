...
class RebConversionApi
{
     ...
     */
    public function rebConversionConvertToExcel($reb_file = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        list($response) = $this->rebConversionConvertToExcelWithHttpInfo($reb_file, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices);
        return $response;
    }
     ...
     */
    public function rebConversionConvertToExcelWithHttpInfo($reb_file = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToExcelRequest($reb_file, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToExcelAsync($reb_file = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        return $this->rebConversionConvertToExcelAsyncWithHttpInfo($reb_file, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rebConversionConvertToExcelAsyncWithHttpInfo($reb_file = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->rebConversionConvertToExcelRequest($reb_file, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rebConversionConvertToExcelRequest($reb_file = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
