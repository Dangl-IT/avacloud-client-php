...
class AvaConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function avaConversionConvertToGaeb($ava_project, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        list($response) = $this->avaConversionConvertToGaebWithHttpInfo($ava_project, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function avaConversionConvertToGaebWithHttpInfo($ava_project, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToGaebRequest($ava_project, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToGaebAsync($ava_project, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        return $this->avaConversionConvertToGaebAsyncWithHttpInfo($ava_project, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToGaebAsyncWithHttpInfo($ava_project, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToGaebRequest($ava_project, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function avaConversionConvertToGaebRequest($ava_project, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        // verify the required parameter 'ava_project' is set
        if ($ava_project === null || (is_array($ava_project) && count($ava_project) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \SplFileObject
     */
    public function avaConversionConvertToOenorm($ava_project, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        list($response) = $this->avaConversionConvertToOenormWithHttpInfo($ava_project, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function avaConversionConvertToOenormWithHttpInfo($ava_project, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToOenormRequest($ava_project, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToOenormAsync($ava_project, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        return $this->avaConversionConvertToOenormAsyncWithHttpInfo($ava_project, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToOenormAsyncWithHttpInfo($ava_project, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToOenormRequest($ava_project, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function avaConversionConvertToOenormRequest($ava_project, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        // verify the required parameter 'ava_project' is set
        if ($ava_project === null || (is_array($ava_project) && count($ava_project) === 0)) {
            throw new \InvalidArgumentException(
