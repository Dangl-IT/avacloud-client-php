...
class AvaConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function avaConversionConvertToGaeb($ava_project, $try_auto_generate_item_numbers_and_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null)
    {
        list($response) = $this->avaConversionConvertToGaebWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function avaConversionConvertToGaebWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToGaebRequest($ava_project, $try_auto_generate_item_numbers_and_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToGaebAsync($ava_project, $try_auto_generate_item_numbers_and_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null)
    {
        return $this->avaConversionConvertToGaebAsyncWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToGaebAsyncWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToGaebRequest($ava_project, $try_auto_generate_item_numbers_and_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function avaConversionConvertToGaebRequest($ava_project, $try_auto_generate_item_numbers_and_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null, $remove_unprintable_characters_from_texts = null)
    {
        // verify the required parameter 'ava_project' is set
        if ($ava_project === null || (is_array($ava_project) && count($ava_project) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \SplFileObject
     */
    public function avaConversionConvertToReb($ava_project, $try_auto_generate_item_numbers_and_schema = null)
    {
        list($response) = $this->avaConversionConvertToRebWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function avaConversionConvertToRebWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToRebRequest($ava_project, $try_auto_generate_item_numbers_and_schema);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToRebAsync($ava_project, $try_auto_generate_item_numbers_and_schema = null)
    {
        return $this->avaConversionConvertToRebAsyncWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToRebAsyncWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToRebRequest($ava_project, $try_auto_generate_item_numbers_and_schema);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function avaConversionConvertToRebRequest($ava_project, $try_auto_generate_item_numbers_and_schema = null)
    {
        // verify the required parameter 'ava_project' is set
        if ($ava_project === null || (is_array($ava_project) && count($ava_project) === 0)) {
            throw new \InvalidArgumentException(
