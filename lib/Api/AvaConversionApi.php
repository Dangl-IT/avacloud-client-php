...
class AvaConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function avaConversionConvertToExcel($ava_project, $try_auto_generate_item_numbers_and_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        list($response) = $this->avaConversionConvertToExcelWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function avaConversionConvertToExcelWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToExcelRequest($ava_project, $try_auto_generate_item_numbers_and_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToExcelAsync($ava_project, $try_auto_generate_item_numbers_and_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        return $this->avaConversionConvertToExcelAsyncWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function avaConversionConvertToExcelAsyncWithHttpInfo($ava_project, $try_auto_generate_item_numbers_and_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->avaConversionConvertToExcelRequest($ava_project, $try_auto_generate_item_numbers_and_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function avaConversionConvertToExcelRequest($ava_project, $try_auto_generate_item_numbers_and_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null, $lock_all_cells_but_prices = null)
    {
        // verify the required parameter 'ava_project' is set
        if ($ava_project === null || (is_array($ava_project) && count($ava_project) === 0)) {
            throw new \InvalidArgumentException(
