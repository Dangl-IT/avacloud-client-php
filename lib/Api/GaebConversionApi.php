...
class GaebConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function gaebConversionConvertToGaeb($gaeb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        list($response) = $this->gaebConversionConvertToGaebWithHttpInfo($gaeb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function gaebConversionConvertToGaebWithHttpInfo($gaeb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->gaebConversionConvertToGaebRequest($gaeb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gaebConversionConvertToGaebAsync($gaeb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        return $this->gaebConversionConvertToGaebAsyncWithHttpInfo($gaeb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gaebConversionConvertToGaebAsyncWithHttpInfo($gaeb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->gaebConversionConvertToGaebRequest($gaeb_file, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function gaebConversionConvertToGaebRequest($gaeb_file = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null, $export_quantity_determination = null)
    {
     ...
     * @return \SplFileObject
     */
    public function gaebConversionConvertToOenorm($gaeb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        list($response) = $this->gaebConversionConvertToOenormWithHttpInfo($gaeb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function gaebConversionConvertToOenormWithHttpInfo($gaeb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->gaebConversionConvertToOenormRequest($gaeb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gaebConversionConvertToOenormAsync($gaeb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        return $this->gaebConversionConvertToOenormAsyncWithHttpInfo($gaeb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gaebConversionConvertToOenormAsyncWithHttpInfo($gaeb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->gaebConversionConvertToOenormRequest($gaeb_file, $destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function gaebConversionConvertToOenormRequest($gaeb_file = null, $destination_oenorm_type = null, $try_repair_project_structure = null, $skip_try_enforce_schema_compliant_xml_output = null)
    {
