...
class ExcelConversionApi
{
     ...
     * @return \SplFileObject
     */
    public function excelConversionConvertToGaeb($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null)
    {
        list($response) = $this->excelConversionConvertToGaebWithHttpInfo($excel_file, $read_new_elements, $rebuild_item_number_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function excelConversionConvertToGaebWithHttpInfo($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->excelConversionConvertToGaebRequest($excel_file, $read_new_elements, $rebuild_item_number_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function excelConversionConvertToGaebAsync($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null)
    {
        return $this->excelConversionConvertToGaebAsyncWithHttpInfo($excel_file, $read_new_elements, $rebuild_item_number_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function excelConversionConvertToGaebAsyncWithHttpInfo($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->excelConversionConvertToGaebRequest($excel_file, $read_new_elements, $rebuild_item_number_schema, $destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function excelConversionConvertToGaebRequest($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $destination_gaeb_type = null, $target_exchange_phase_transform = null, $enforce_strict_offer_phase_long_text_output = null)
    {
