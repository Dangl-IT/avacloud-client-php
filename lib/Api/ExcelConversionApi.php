...
class ExcelConversionApi
{
     ...
     */
    public function excelConversionConvertToExcel($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null)
    {
        list($response) = $this->excelConversionConvertToExcelWithHttpInfo($excel_file, $read_new_elements, $rebuild_item_number_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers);
        return $response;
    }
     ...
     */
    public function excelConversionConvertToExcelWithHttpInfo($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->excelConversionConvertToExcelRequest($excel_file, $read_new_elements, $rebuild_item_number_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function excelConversionConvertToExcelAsync($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null)
    {
        return $this->excelConversionConvertToExcelAsyncWithHttpInfo($excel_file, $read_new_elements, $rebuild_item_number_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function excelConversionConvertToExcelAsyncWithHttpInfo($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->excelConversionConvertToExcelRequest($excel_file, $read_new_elements, $rebuild_item_number_schema, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function excelConversionConvertToExcelRequest($excel_file = null, $read_new_elements = null, $rebuild_item_number_schema = null, $write_prices = null, $write_long_texts = null, $conversion_culture = null, $include_article_numbers = null)
    {
