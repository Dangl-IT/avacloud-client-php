...
**is_undivided_position** | **bool** | This indicates if the ÖNorm position / note text was a &#39;ungeteilteposition&#39; (undivided position). This will only be taken into account when the position / note text is also the sole element inside it&#39;s parent group | 
