...
```php
rebConversionConvertToAva($remove_plain_text_long_texts, $remove_html_long_texts, $reb_file): \Dangl\AVACloud\Model\ProjectDto
```
...
try {
    $result = $apiInstance->rebConversionConvertToAva($remove_plain_text_long_texts, $remove_html_long_texts, $reb_file);
    print_r($result);
} catch (Exception $e) {
...
| **reb_file** | **\SplFileObject****\SplFileObject**| The input file | [optional] |
...
```php
rebConversionConvertToExcel($write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices, $reb_file): \SplFileObject
```
...
try {
    $result = $apiInstance->rebConversionConvertToExcel($write_prices, $write_long_texts, $conversion_culture, $include_article_numbers, $lock_all_cells_but_prices, $reb_file);
    print_r($result);
} catch (Exception $e) {
...
```php
rebConversionConvertToFlatAva($reb_file): \Dangl\AVACloud\Model\FlatAvaProject
```
...
try {
    $result = $apiInstance->rebConversionConvertToFlatAva($reb_file);
    print_r($result);
} catch (Exception $e) {
...
```php
rebConversionConvertToGaeb($destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts, $force_include_descriptions, $treat_null_item_number_schema_as_invalid, $reb_file): \SplFileObject
```
...
try {
    $result = $apiInstance->rebConversionConvertToGaeb($destination_gaeb_type, $target_exchange_phase_transform, $enforce_strict_offer_phase_long_text_output, $export_quantity_determination, $remove_unprintable_characters_from_texts, $force_include_descriptions, $treat_null_item_number_schema_as_invalid, $reb_file);
    print_r($result);
} catch (Exception $e) {
...
```php
rebConversionConvertToOenorm($destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output, $remove_unprintable_characters_from_texts, $reb_file): \SplFileObject
```
...
try {
    $result = $apiInstance->rebConversionConvertToOenorm($destination_oenorm_type, $try_repair_project_structure, $skip_try_enforce_schema_compliant_xml_output, $remove_unprintable_characters_from_texts, $reb_file);
    print_r($result);
} catch (Exception $e) {
