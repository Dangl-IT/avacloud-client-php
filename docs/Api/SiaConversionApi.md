...
```php
siaConversionConvertToAva($siaFile, $removePlainTextLongTexts, $removeHtmlLongTexts): \Dangl\AVACloud\Model\ProjectDto
```
...
$siaFile = '/path/to/file.txt'; // \SplFileObject | The input file
...
try {
    $result = $apiInstance->siaConversionConvertToAva($siaFile, $removePlainTextLongTexts, $removeHtmlLongTexts);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **siaFile** | **\SplFileObject****\SplFileObject**| The input file | [optional] |
...
```php
siaConversionConvertToExcel($siaFile, $writePrices, $writeLongTexts, $conversionCulture, $includeArticleNumbers, $lockAllCellsButPrices): \SplFileObject
```
...
try {
    $result = $apiInstance->siaConversionConvertToExcel($siaFile, $writePrices, $writeLongTexts, $conversionCulture, $includeArticleNumbers, $lockAllCellsButPrices);
    print_r($result);
} catch (Exception $e) {
...
```php
siaConversionConvertToFlatAva($siaFile): \Dangl\AVACloud\Model\FlatAvaProject
```
...
try {
    $result = $apiInstance->siaConversionConvertToFlatAva($siaFile);
    print_r($result);
} catch (Exception $e) {
...
```php
siaConversionConvertToGaeb($siaFile, $destinationGaebType, $targetExchangePhaseTransform, $enforceStrictOfferPhaseLongTextOutput, $exportQuantityDetermination, $removeUnprintableCharactersFromTexts, $forceIncludeDescriptions, $treatNullItemNumberSchemaAsInvalid): \SplFileObject
```
...
try {
    $result = $apiInstance->siaConversionConvertToGaeb($siaFile, $destinationGaebType, $targetExchangePhaseTransform, $enforceStrictOfferPhaseLongTextOutput, $exportQuantityDetermination, $removeUnprintableCharactersFromTexts, $forceIncludeDescriptions, $treatNullItemNumberSchemaAsInvalid);
    print_r($result);
} catch (Exception $e) {
...
```php
siaConversionConvertToOenorm($siaFile, $destinationOenormType, $tryRepairProjectStructure, $skipTryEnforceSchemaCompliantXmlOutput, $removeUnprintableCharactersFromTexts): \SplFileObject
```
...
try {
    $result = $apiInstance->siaConversionConvertToOenorm($siaFile, $destinationOenormType, $tryRepairProjectStructure, $skipTryEnforceSchemaCompliantXmlOutput, $removeUnprintableCharactersFromTexts);
    print_r($result);
} catch (Exception $e) {
