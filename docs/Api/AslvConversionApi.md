...
> \SplFileObject aslvConversionConvertToExcel($aslv_file, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers)
...
try {
    $result = $apiInstance->aslvConversionConvertToExcel($aslv_file, $write_prices, $write_long_texts, $conversion_culture, $include_article_numbers);
    print_r($result);
} catch (Exception $e) {
