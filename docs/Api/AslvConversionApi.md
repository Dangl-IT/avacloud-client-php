# Swagger\Client\AslvConversionApi
...
> \Swagger\Client\Model\ProjectDto aslvConversionConvertToAva($aslv_file, $remove_plain_text_long_texts, $remove_html_long_texts)
...
$apiInstance = new Swagger\Client\Api\AslvConversionApi(
