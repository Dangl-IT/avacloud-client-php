...
------------ | ------------- | ------------- | -------------
**destination_gaeb_type** | [**\Dangl\AVACloud\Model\DestinationGaebType**](DestinationGaebType.md) |  |
**target_exchange_phase_transform** | [**\Dangl\AVACloud\Model\DestinationGaebExchangePhase**](DestinationGaebExchangePhase.md) |  |
