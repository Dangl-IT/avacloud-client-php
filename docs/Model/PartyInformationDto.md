...
**tax_id** | **string** | This can be used to specify a tax id for this party. It is different from the VatId and the RegistrationNumber. For example, in Germany this would be the \&quot;Steuernummer\&quot;. This is usually not mapped to any AVA exchanges, but it&#39;s used e.g. in the XRechnung electronic invoices. | [optional]
