...
**due_date** | [**\DateTime**](\DateTime.md) | The date until which the payment term applies. | [optional] 
...
**base_date** | [**\DateTime**](\DateTime.md) | The base date for calculating the discount period. This is typically the invoice date. | [optional] 
