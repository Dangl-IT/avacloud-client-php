...
**alignment** | [**\Dangl\AVACloud\Model\ItemNumberSchemaTierAlignmentDto**](ItemNumberSchemaTierAlignmentDto.md) | This enum represents the alignment value for a tier in an ItemNumberSchema. It is not used anywhere for computations at the moment, and is mostly an informational value. | [optional] 
